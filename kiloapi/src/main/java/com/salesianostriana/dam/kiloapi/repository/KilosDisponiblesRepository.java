...
public interface KilosDisponiblesRepository extends JpaRepository<KilosDisponibles, TipoAlimento> {
    @Query("select new com.salesianostriana.dam.kiloapi.dto.TipoAlimentoDto(t.id, t.nombre, k.cantidadDisponible)from TipoAlimento t JOIN t.kilosDisponibles k")
